...
public:
	...
	GeoFeature* SearchQuadTree(GeoPoint *point, int thresholed);//四叉树索引查询
	GeoFeature* SearchQuadBranch(int depth, QuadNode *node, GeoPoint *point, int thresholed);//递归查询各个分支
